...
public class VistaVenta extends javax.swing.JFrame implements IVenta {
     ...
     * @param t
     */
    public VistaVenta(Tienda t) {
        initComponents();
        tienda = t;
        controlador = new Controlador(this);
        this.setBounds(0, 0, 1366, 760);
        this.pack();
    ...
    private void initComponents() {
        ...
        jTableAgregados.setAutoCreateRowSorter(true);
        ...
        jTableAgregados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Producto", "Tomate", "Lechuga", "Mayonesa", "Mostaza", "Queso", "Jamon", "Huevo", "Aji", "Subtotal"
            }
        ) {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(91, 91, 91)
                        .addComponent(jButtonFacturar, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jButtonFacturar, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButtonAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAgregarActionPerformed
        ...
        jTableAgregados.setVisible(true);
        int cantidad = Integer.parseInt(jTextFieldCantidad.getText());
        if (pro.getRubro().getId() == 1) {
            //TODO configuracion de productos con agregados y se guarda en la variable pro
            for (int i = 0; i < jTableAgregados.getRowCount(); i++) {
                for (int j = 0; j < 8; j++) {
                    pro.getAgregado().get(j).setIncluido((Boolean) jTableAgregados.getValueAt(i, j + 1));
                }
                mostrarDetaVenta(pro, 1);
            }
        } else {
    ...
    private void jButtonAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAceptarActionPerformed
        ...
        for (int i = 0; i < jTableDetaVenta.getRowCount(); i++) {
    ...
    private void jButtonFacturarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonFacturarActionPerformed
        ...
        limpiarTablaDetaVenta((DefaultTableModel) jTableDetaVenta.getModel());
    ...
    private void jMenuCerrarSesionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenuCerrarSesionMouseClicked
        ...
        FinSesion vista = new FinSesion(tienda);
    ...
    private void jButtonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEliminarActionPerformed
        if (JOptionPane.showConfirmDialog(null, "¿Desea confirmar la eliminacion de la venta?", "Eliminar Venta", JOptionPane.YES_OPTION) == 0) {
            limpiarTablaDetaVenta((DefaultTableModel) jTableDetaVenta.getModel());
            iniciador();
        }
    ...
    private void jComboBoxProductosItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBoxProductosItemStateChanged
        Producto pro = (Producto) evt.getItem();
        jTableAgregados.setVisible(true);
        int cantidad = Integer.parseInt(jTextFieldCantidad.getText());
        if (pro.getRubro().getId() == 1) {
            mostrarAgregados(pro, cantidad);
        } else
    ...
    public void iniciador() {
        ...
        mostrarRubros();
        mostrarProductos(Creador.getCatalogo(), (Rubro) jComboBoxRubro.getItemAt(0));
        mostrarAgregados((Producto) jComboBoxProductos.getItemAt(0), Integer.parseInt(jTextFieldCantidad.getText()));
    }
    ...
    private void mostrarAgregados(Producto pro, int cantidad) {
        jTableAgregados.setVisible(true);
        DefaultTableModel tabla = (DefaultTableModel) jTableAgregados.getModel();
        limpiador(tabla);
        for (int i = 0; i < cantidad; i++) {
            Object[] fila = {"", false, false, false, false, false, false, false, false, ""};
            tabla.addRow(fila);            
            jTableAgregados.setValueAt(pro.toString(), i, 0);
            for (int j = 0; j < pro.getAgregado().size(); j++) {
                jTableAgregados.setValueAt(pro.getAgregado().get(j).isIncluido(), i, j + 1);
            }
            jTableAgregados.setValueAt(pro.getPrecio(), i, 9);
        }
    }
    ...
    private void limpiarTablaDetaVenta(DefaultTableModel tabla) {
        limpiador(tabla);
        jTextFieldTotal.setText("0");
        jButtonEliminar.setEnabled(false);
    }

    private void limpiador(DefaultTableModel tabla) {

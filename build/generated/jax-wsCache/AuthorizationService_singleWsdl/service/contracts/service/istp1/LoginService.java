 ...
 * 
 */
@WebServiceClient(name = "LoginService", targetNamespace = "http://ISTP1.Service.Contracts.Service", wsdlLocation = "http://ds.dyndns.org:9000/AuthorizationService?singleWsdl")
    ...
    extends Service
{
    ...
    private final static QName LOGINSERVICE_QNAME = new QName("http://ISTP1.Service.Contracts.Service", "LoginService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://ds.dyndns.org:9000/AuthorizationService?singleWsdl");
    ...
    public ILoginService getSGEAuthService() {
        return super.getPort(new QName("http://ISTP1.Service.Contracts.Service", "SGEAuthService"), ILoginService.class);
    }
    ...
    public ILoginService getSGEAuthService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ISTP1.Service.Contracts.Service", "SGEAuthService"), ILoginService.class, features);
    }
